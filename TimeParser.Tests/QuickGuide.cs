...
namespace TimeSpanParserUtil.Tests {
    ...
    public class QuickGuide {
        ...
        [TestMethod]
        [DataRow("5 mins", "00:05:00")] // such as "5 mins"
        ...
        public void GuideSettingOptionsTests2() {
            ...
            // ...Unless you set the UncolonedDefault option to default to minutes.
            ...
            //UncolonedDefault is what to interpret a number as by default. e.g. if seconds, then text of "3" becomes 3 seconds
            options.UncolonedDefault = Units.Seconds;
            Assert.AreEqual(TimeSpanParser.Parse("3", options), TimeSpan.FromSeconds(3));

            // if Units.None is chosen then parsing will fail if the user has not included a unit
            ...
            // It will automatically switch to hours again if a number contains too many colons
            ...
            try {
                TimeSpanParser.Parse("33s 3", options);
                Assert.Fail("Above should throw an exception before this line is reached.");
            } catch { }
        ...
        public void GuideSettingOptionsTests3() {
            ...
            // And parsing will stop when the order is broken
